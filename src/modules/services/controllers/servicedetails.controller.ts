...
@ApiOperation({
  summary:
    'Complete service details after approval (FOOD, PHOTOGRAPHY, FAVORS, DECORATION)',
  description:
    'Add availability schedule and optional media. After this, you can add sub-services.',
})
@ApiParam({ name: 'serviceId', description: 'Service ID' })
@ApiResponse({
  status: 200,
  description: 'Service details completed successfully',
})
@ApiResponse({
  status: 400,
